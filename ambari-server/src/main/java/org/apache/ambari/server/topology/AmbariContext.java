      ...
      for (String component : entry.getValue()) {
        ...
        try {
          if (cluster.getService(service) != null && !component.equals(RootComponent.AMBARI_SERVER.name())) {
            // TODO  : SWAPAN should the component be same ?
            requests.add(new ServiceComponentHostRequest(clusterName, DEFAULT_SERVICE_GROUP_NAME, service, component, component, hostName, null));
          }
